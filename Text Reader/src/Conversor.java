    ...
    public void ArmarOracion(String path) {
        ...
        while (t.hasMoreTokens()) {
            ...
            if (word.hashCode() == Evaluacion.ver(i).hashCode()) {
                ...
                while (foo <= Evaluacion.size - 1) {
                    ...
                    if (word.hashCode() == Evaluacion.ver(foo).hashCode()) {
                        ...
                        while (cuenta < s) {
                            ...
                            System.out.println("sin igualdad-- " + foodos.ver(foodos.size - 1 - cuenta));
                ...
                if (cont == Evaluacion.size) {

                    s = 0;

                    int sal = 0;

                    while (sal <= Evaluacion.size - 1) {
